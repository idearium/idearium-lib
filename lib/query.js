...
/**
 * Creates findDocuments and findOneDocument on the schema which are aliases to the find and findOne functions.
 * @param {Object} schema The mongoose schema object.
 * @returns {Void} Creates the findDocuments and findOneDocument static functions.
 */
const queryPlugin = function queryPlugin (schema) {

    schema.statics.findDocuments = function findDocuments (opts) {
        return find(this, opts);
    };

    schema.statics.findOneDocument = function findOneDocument (opts) {
        return findOne(this, opts);
    };
