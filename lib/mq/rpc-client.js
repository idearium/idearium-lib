...
class RpcClient extends Connection {
    ...
    setupRpc() {
        ...
        return this.connection.createChannel()
            ...
            .then((q) => {
                ...
                log.info(`RPC client is awaiting publishing requests [${q.queue}]`);
    ...
    promiseManager(rpcName, correlationId, data, timeout, resolve, reject) {
        ...
        this.channel.sendToQueue(rpcName, Buffer.from(JSON.stringify(data)), {
            correlationId,
    ...
    setupConsumer() {
        ...
        return this.channel.consume(this.queue.queue, (msg) => {
            ...
            if (!correlation) {
                log.info('correlationId %s not found', msg.properties.correlationId);
                return;
            }
